...
export default function CardSide() {
  return (
    <>
    <div className="card max-sm:my-5 flex flex-col rounded-3xl border-blue-500 border-solid bg-slate-800 border-[1.571px] w-[300px]">
      <div className="flex overflow-hidden relative flex-col items-center px-5 py-2 w-full min-h-[541px]">
        ...
        <img
          src={Ticket_left}
          className="tleft rotate-6 me-8 mt-16 pdmax-w-full absolute bottom-25 aspect-[0.62] w-[180px] z-9"
        />
        <img
          src={Ticket_right}
          className="tright -rotate-6  ml-8 mt-16 max-w-full absolute bottom-25 aspect-[0.62] w-[180px] z-9 hover:rotate-6"
        />
        <div className="absolute">
            <img
          src={ticket}
          className="mt-16 max-w-full bottom-25 aspect-[0.62] w-[180px] z-10 "
        />
